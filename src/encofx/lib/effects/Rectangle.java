 ...
 * @author Yves
 */
public class Rectangle extends FXObject {
    ...
    public static Color getActualColor(Rectangle before, Rectangle after, int actualframe){
    ...
    public static float getActualX(Rectangle before, Rectangle after, Point2D anchor, int actualframe){
    ...
    public static float getActualY(Rectangle before, Rectangle after, Point2D anchor, int actualframe){
    ...
    public static float getActualTransparency(Rectangle before, Rectangle after, int actualframe){        
    ...
    public static float getActualScaleX(Rectangle before, Rectangle after, int actualframe){        
    ...
    public static float getActualScaleY(Rectangle before, Rectangle after, int actualframe){        
    ...
    public static float getActualAngle(Rectangle before, Rectangle after, int actualframe){        
    ...
    public static Color[] getActualGradientColor(Rectangle before, Rectangle after, int actualframe){
    ...
    public static Color[] getActualFourSidesGradientColor(Rectangle before, Rectangle after, int actualframe){
