 ...
 * @author Yves
 */
public class Text extends FXObject {
    ...
    public static float getActualSize(Text before, Text after, int actualframe){        
    ...
    public static float getActualX(Text before, Text after, Point2D anchor, int actualframe){
    ...
    public static float getActualY(Text before, Text after, Point2D anchor, int actualframe){
    ...
    public static float getActualTransparency(Text before, Text after, int actualframe){        
    ...
    public static float getActualScaleX(Text before, Text after, int actualframe){        
    ...
    public static float getActualScaleY(Text before, Text after, int actualframe){        
    ...
    public static float getActualAngle(Text before, Text after, int actualframe){        
    ...
    public static Color[] getActualGradientColor(Text before, Text after, int actualframe){
    ...
    public static Color[] getActualFourSidesGradientColor(Text before, Text after, int actualframe){
