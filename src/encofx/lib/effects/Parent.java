...
public class Parent extends FXObject implements Cloneable {
    ...
    public static float getActualSize(Parent before, Parent after, int actualframe){        
    ...
    public static float getActualX(Parent before, Parent after, Point2D anchor, int actualframe){
    ...
    public static float getActualY(Parent before, Parent after, Point2D anchor, int actualframe){
    ...
    public static float getActualTransparency(Parent before, Parent after, int actualframe){        
    ...
    public static float getActualScaleX(Parent before, Parent after, int actualframe){        
    ...
    public static float getActualScaleY(Parent before, Parent after, int actualframe){        
    ...
    public static float getActualAngle(Parent before, Parent after, int actualframe){        
    ...
    public static Color[] getActualGradientColor(Parent before, Parent after, int actualframe){
    ...
    public static Color[] getActualFourSidesGradientColor(Parent before, Parent after, int actualframe){
